...
public final class Math {
	...
	/**
	 * Returns an array of the original array's delta values.
	 * @param a The original array
	 * @return The constructed output array
	 */
	public static int[]delta(int[]a){
		if(a.length<2)return new int[0];
	...
	public static int min(int...a){
		...
		for(int b:a)v=Math.min(v,b);
		return v;
	}
	
	public static int max(int...a){
		int v=Integer.MIN_VALUE;
		for(int b:a)v=Math.max(v,b);
		return v;
	}
	...
	**/
	...
	/**
	 * Calculates the greatest common factor of two ints
	...
	/**
	 * Finds floor(sqrt(n)), for BigInteger n.
