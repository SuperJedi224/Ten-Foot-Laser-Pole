...
public class Complex extends Number{
	/**
	 * This exception is thrown when calling intValue, longValue, etc. on a Complex object representing a nonreal value.
	 * @author Johnathan Waugh
	 */
	public final class NonrealAnswerException extends ArithmeticException{
		private static final long serialVersionUID = 1L;
		public NonrealAnswerException(){}
	}
	/**
	 ...
	 * @throws NonrealAnswerException when this Complex object represents a nonreal value
	 */
	public int intValue() {
		if(isReal())return (int)a;
		throw new NonrealAnswerException();
	}
	/**
