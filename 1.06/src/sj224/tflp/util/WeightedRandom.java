 ...
 * A WeightedRandom implementation.
 * @param <T> The type of object this WeightedRandom generates
 */
public class WeightedRandom<T>{
	...
	/**
	 * If the specified element has already been registered, increments is weight; otherwise, registers it with a weight of 1.
	 * @param element The element to be assigned.
	 * @throws java.lang.IllegalArgumentException if the given element is null.
	 */
